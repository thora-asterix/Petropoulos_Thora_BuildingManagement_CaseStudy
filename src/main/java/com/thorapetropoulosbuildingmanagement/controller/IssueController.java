...
public class IssueController {
	...
	private IssueArchivedService issueArchivedService;
	 ...
	 @GetMapping("/addNewIssue")
	    ...
	    public String saveIssue(@ModelAttribute("issueObject") Issue issue, @RequestParam(name = "idApartment") String idApartment, @RequestParam(name = "idService") String idService ) {
	    ...
	    public String saveUpdatedIssue(@ModelAttribute("issueObject") Issue issue, @RequestParam(name = "idApartment") String idApartment, @RequestParam(name = "idService") String idService, @RequestParam(name = "openDate") String openDate ) {
	    	// save service to database
	    	Integer theServiceId = Integer.parseInt(idService);
	    	ServiceProvided sProvided = serviceProvidedService.findById(theServiceId);
	 	    System.out.println("This is the service object "+ sProvided);
